...
async function postPhoto({ message, imageUrl, facebookPageId, facebookToken }) {
...
async function getTokenInfo({ facebookAppId, facebookAppSecret, facebookToken } = {}) {
  const appId = facebookAppId || process.env.FACEBOOK_APP_ID;
  const appSecret = facebookAppSecret || process.env.FACEBOOK_APP_SECRET;
  const token = facebookToken || process.env.FACEBOOK_ACCESS_TOKEN;
...
async function refreshToken({ facebookAppId, facebookAppSecret, facebookToken } = {}) {
  const appId = facebookAppId || process.env.FACEBOOK_APP_ID;
  const appSecret = facebookAppSecret || process.env.FACEBOOK_APP_SECRET;
  const shortToken = facebookToken || process.env.FACEBOOK_ACCESS_TOKEN;
